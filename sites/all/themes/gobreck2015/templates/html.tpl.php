...
<link type="text/css" rel="stylesheet" media="all" href="/sites/all/themes/gobreck2015/css/fontface.css" />
<?php print $styles; ?>
<?php print $scripts; ?>
<?php print $polyfills; ?>
...
<body class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <script src="//4oney.com/hc/hms-v2.0.js" type="text/javascript"></script>
</body>
<?php
  global $user;
  if ($user->uid == 3 || user_access('access administration pages')) {

   echo "<script type='text/javascript'>
   jQuery(document).ready(function() {
   jQuery('body').addClass('corey');
jQuery('div.overlay-text').addClass('corey');
   });
   </script>";
