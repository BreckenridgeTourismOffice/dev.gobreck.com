...
$('.view-image-tiles .views-row').each(function() {
...
//$(currentImg).css('padding-bottom','24px');
...
//**********DOC READY FUNCTIONS*****//
/*
$('#block-views-photo-gallery-block-2 .views-field-nothing .field-content').each(function() {
var currentImg = $(this).find("img");
var imageH = $(currentImg).outerHeight();
var imageW = $(currentImg).outerWidth();
var titleMargin =0-( (imageH/2)+30);
